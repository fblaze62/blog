...
我使用 Rime 也已经有1年多了，便决定写一篇文章记录我的使用经历和感受了。
...
这款配置方案的功能已经足够满足日常使用。相比于 朙月拼音，雾凇拼音拥有更好的词库和 Emoji 输入、中英混打、计算器等多项功能。我也使用了这套方案很长时间。
...
这套方案还有普通版和 Pro（辅助码）版本，能完全满足日常使用需求。

## 感受

使用 Rime 一年下来的感受就是确实做到了纯净无广告和高自定义程度。

在输入法连候选项都要插入广告的当下，或许只有开源软件能做到让你不被广告打扰。

高自定义程度意味着你能把输入法打造成你想要的任何模样。无论想要什么输入法、什么功能，都能够在 Rime 中实现。向辅助码这种功能更是大厂输入法都几乎没有的，只能通过 Rime 来定制。
