...
> [!TIP]
> 以下内容适用于基于 Debian 的 Linux 发行版，其他发行版的操作方法（如命令）可能有所不同。
...
然后再次右键“中”，选择重新部署。Rime 每次修改配置都要重新部署才能生效。Linux 用户请右键输入法图标（㞢），并展开方案名称选择重新部署。
...
另外，说个题外话。如果你只想要纯净无广告的特点的话，可以试试[微信输入法](https://z.weixin.qq.com/)。
