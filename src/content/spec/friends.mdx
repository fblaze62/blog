...
export const site = {
  name: "FeatherBlaze's Blog",
  desc: "FeatherBlaze 的个人博客，记录学习和生活。",
  url: "https://blog.fblaze62.top",
  avatar: "https://gcore.jsdelivr.net/gh/fblaze62/blog@main/src/assets/images/avatar-round.png",
  email: "hi@fblaze62.top",
};
