...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "FeatherBlaze's Blog",

	// 站点副标题
	subtitle: "",

	// 站点 URL
	site_url: "https://blog.fblaze62.top",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/fb-light.png",
			valueDark: "assets/images/logo/fb-dark.png",
			alt: "FB",
		},
		// 导航栏标题
		title: "FeatherBlaze",
